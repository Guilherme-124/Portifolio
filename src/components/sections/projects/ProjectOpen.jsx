export const ProjectOpen = ({index, setOpenMore}) => {
  return (
    <>
      ...
      <div className="fixed flex bg-[rgba(20,20,20)] w-[80%] right-[10%] top-[30px] bottom-0 
        rounded mx-auto gap-[15px] z-900">
        <div className="grid grid-cols-2 p-0">
          <div className="p-2 overflow-y-auto">
            ...
            <div className="text-[1.5vw]">
              <h1 className="text-[1.7vw]">title {index+1}</h1>
              <h2 className="text-[.7rem] flex-wrap">I'm currently working on some small backend stuff
                that i plan to do to deploy the programs and codes in here
              </h2>
            </div>
          </div>
          <div className="bg-white text-black text-[1.5vw] rounded p-2 
